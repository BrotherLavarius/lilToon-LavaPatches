Shader "lilToon/Lava Metallic"
{
    ...
    SubShader
    {
        ...
        UsePass "Hidden/ltspass_lava/FORWARD"
        UsePass "Hidden/ltspass_lava/SHADOW_CASTER"
        UsePass "Hidden/ltspass_lava/DEPTHONLY"
        UsePass "Hidden/ltspass_lava/DEPTHNORMALS"
        UsePass "Hidden/ltspass_lava/MOTIONVECTORS"
        UsePass "Hidden/ltspass_lava/UNIVERSAL2D"
        UsePass "Hidden/ltspass_lava/META"
        Pass
        {
